...
var StopOrder = function (_Component) {
	...
	function StopOrder(props) {
		...
		var _this = _possibleConstructorReturn(this, (StopOrder.__proto__ || Object.getPrototypeOf(StopOrder)).call(this, props));
	...
	_createClass(StopOrder, [{
		...
		value: function drawOnCanvas(ctx, moreProps) {
			...
			const distanceInPips = getDistanceInPips(symbol, orderType, stopOrderType, marketOrPendingPrice, yValue)
			const slOrTp = stopOrderType === 'sl' ? 'stop loss' : 'take profit'
    	...
    	ctx.fillText(`${slOrTp} (${distanceInPips})`, x, y);
		}
	}, {
		key: "render",
		...
		value: function renderSVG(moreProps) {
			...
			const { stopOrderType, symbol, stroke, strokeWidth, opacity, strokeDasharray } = this.props;
			const { yValue } = this.props;

			const lineCoordinates = getLineCoordinates(yScale, yValue, width);
			const textCoordinates = getTextCoordinates(symbol, yScale, yValue, width);
			const stopLossOrTakeProfit = stopOrderType === "sl" ? "stop loss" : "take profit";

			return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("text", _extends({
				className: className,
				strokeDasharray: (0, _utils.getStrokeDasharray)(strokeDasharray),
				stroke: stroke,
				strokeWidth: strokeWidth,
				strokeOpacity: opacity
			}, textCoordinates), stopLossOrTakeProfit, " (", distanceInPips, ")"), /*#__PURE__*/_react.default.createElement("line", _extends({
				className: className,
				strokeDasharray: (0, _utils.getStrokeDasharray)(strokeDasharray),
				stroke: stroke,
				strokeWidth: strokeWidth,
...
function getDistanceInPips(symbol, orderType, stopOrderType, marketOrPendingPrice, yValue) {
	...
	if (orderType === "buy" && stopOrderType === "sl" ||
	...
	} else if (orderType === "buy" && stopOrderType === "tp" ||
