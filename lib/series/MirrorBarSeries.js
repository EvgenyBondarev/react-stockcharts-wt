...
var MirrorBarSeries = (function(_Component) {
	_inherits(MirrorBarSeries, _Component)

	function MirrorBarSeries(props) {
		_classCallCheck(this, MirrorBarSeries)

		var _this = _possibleConstructorReturn(
			this,
			(
				MirrorBarSeries.__proto__ || Object.getPrototypeOf(MirrorBarSeries)
			).call(this, props)
		)
	...
	_createClass(MirrorBarSeries, [
		{
			...
			value: function drawOnCanvas(ctx, moreProps) {
				if (this.props.swapScales) {
					...
					;(0, _StackedBarSeries.drawOnCanvasHelper)(
						ctx,
						this.props,
						moreProps,
						xAccessor,
						_StackedBarSeries.identityStack
					)
				} else {
	...
	return MirrorBarSeries
})(_react.Component)

MirrorBarSeries.propTypes = {
...
MirrorBarSeries.defaultProps = _StackedBarSeries2.default.defaultProps

exports.default = MirrorBarSeries
