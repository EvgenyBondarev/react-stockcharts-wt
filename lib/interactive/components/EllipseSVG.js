...
var Ellipse = function (_Component) {
...

  {
    ...
    value: function drawOnCanvas(ctx, moreProps) {
      ...
      // ctx.strokeStyle = "rgba(47, 189, 47, .4)";
      ...
      // const offset = 2;
			...
			// const height = 2 * -offset - 1;

      // // top left marker rectangle
      // ctx.beginPath();
      // ctx.fillStyle = "rgba(47, 189, 47, .6)";
			// ctx.moveTo(x1, y1);
      // ctx.fillRect(x1 - offset, y1 + offset, width, height);

      // // bottom left marker rectangle
      // ctx.beginPath();
      // ctx.fillStyle = "rgba(47, 189, 47, .6)";
			// ctx.moveTo(x1, y2);
			// ctx.fillRect(x1 - offset, y2 + offset, width, height);

      // // bottom right marker rectangle
      // ctx.beginPath();
      // ctx.fillStyle = "rgba(47, 189, 47, .6)";
			// ctx.moveTo(x2, y2);
      // ctx.fillRect(x2 - offset, y2 + offset, width, height);

      // // top right marker rectangle
      // ctx.beginPath();
      // ctx.fillStyle = "rgba(47, 189, 47, .6)";
			// ctx.moveTo(x2, y1);
			// ctx.fillRect(x2 - offset, y1 + offset, width, height);
    }
    },
