...
//tolik
var _shape = require("react-stockcharts/lib/interactive/components/ClickableCircle");
    ...
    value: function isHover(moreProps) {
      ...
      if ((0, _utils.isDefined)(onHover)) {
        var _props2 = this.props,
          ...
          x3Value = _props2.x3Value,
          y1Value = _props2.y1Value,
          y2Value = _props2.y2Value,
          y3Value = _props2.y3Value,
          type = _props2.type;
...
// ddsfsdf
         ...
         var _helper2 = helper(this.props, tolMore),
          ...
          x3 = _helper2 ? _helper2.x3 : 0,
          y3 = _helper2 ? _helper2.y3 : 0,
...
function isHovering(_ref3) {
  var x1Value = _ref3.x1Value,
    ...
    x3Value = _ref3.x3Value,
    y3Value = _ref3.y3Value,
  ...
  var middle = [xScale(line.x2), yScale(line.y2)];
  var end = [xScale(line.x3), yScale(line.y3)];
