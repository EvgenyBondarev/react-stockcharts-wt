...
//rectangle svg
var _RectangleSVG = require("../components/RectangleSVG");
...
var EachTrendLine = function (_Component) {
    ...
    ///
  {
    ...
    value: function render() {
      ...
      // var x1 = coords.start.x;
      // var x2 = coords.end.x;
      // var y1 = coords.start.y;
      // var y2 = coords.end.y;
      // var w1 = Math.abs(x2-x1);
      // var w2 = Math.abs((x2 - x2Value) - (x1 - x1Value))
      // var h = Math.abs(y2 - y1);
      // var newX = positive(x2 - x1) ? x1  : x2;
      // var newY = positive(y2 - y1) ? y1 : y2;
      // var newWidth = w1 ;
      // console.log(this.props)
      // console.log("X: " + x1 + " X1: " + x1Value + " X2: " + x2Value)
      // console.log("Y: " + y1 + " Y1: " + y1Value + " Y2: " + y2Value)
      // console.log(w1)
      // console.log(w2)
