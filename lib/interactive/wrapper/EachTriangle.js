...
var _utils2 = require("react-stockcharts/lib/interactive/utils");

var _ChartDataUtil = require("react-stockcharts/lib/utils/ChartDataUtil");
//rectangle svg
var _RectangleSVG = require("react-stockcharts/lib/interactive/components/RectangleSVG");

var _RectangleSVG2 = _interopRequireDefault(_RectangleSVG);
/////
// var _StraightLine = require("../components/StraightLine");

// var _StraightLine2 = _interopRequireDefault(_StraightLine);

var _ClickableCircle = require("react-stockcharts/lib/interactive/components/ClickableCircle");

var _ClickableCircle2 = _interopRequireDefault(_ClickableCircle);

var _HoverTextNearMouse = require("react-stockcharts/lib/interactive/components/HoverTextNearMouse");
  ...
  _createClass(EachTrendLine, [{
    ...
    value: function handleLineDragStart() {
      var _props = this.props,
        ...
        x3Value = _props.x3Value,
        y3Value = _props.y3Value;


      this.dragStart = {
        x1Value: x1Value, y1Value: y1Value,
        x2Value: x2Value, y2Value: y2Value,
        x3Value: x3Value, y3Value: y3Value
      };
    }
  }, {
    key: "handleLineDrag",
    value: function handleLineDrag(moreProps) {
      ...
      var _dragStart = this.dragStart,
        ...
        x3Value = _dragStart.x3Value,
        y3Value = _dragStart.y3Value;
      ...
      var x3 = xScale(x3Value);
      var y3 = yScale(y3Value);
      //tolik
      ...
      var newX3Value = (0, _ChartDataUtil.getXValue)(xScale, xAccessor, [x3 - dx, y3 - dy], fullData);
      var newY3Value = yScale.invert(y3 - dy);
    ...
    ///
  {
    ...
    value: function render() {
      var _props8 = this.props,
        ...
        x3Value = _props8.x3Value,
        y3Value = _props8.y3Value,
        type = _props8.type,
      ...
      return _react2.default.createElement(
        "g",
        null,
        _react2.default.createElement(_RectangleSVG2.default, {
...
EachTrendLine.propTypes = {
  ...
  x3Value: _propTypes2.default.any.isRequired,
  y1Value: _propTypes2.default.any.isRequired,
  y2Value: _propTypes2.default.any.isRequired,
  y3Value: _propTypes2.default.any.isRequired,
