...
var _EachInteractiveYCoordinate2 = _interopRequireDefault(
	_EachInteractiveYCoordinate
)
...
var InteractiveYCoordinate = (function(_Component) {
	...
	function InteractiveYCoordinate(props) {
		...
		var _this = _possibleConstructorReturn(
			this,
			(
				InteractiveYCoordinate.__proto__ ||
				Object.getPrototypeOf(InteractiveYCoordinate)
			).call(this, props)
		)
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					yCoordinateList.map(function(each, idx) {
						var props = each
						return _react2.default.createElement(
							_EachInteractiveYCoordinate2.default,
							_extends(
								{ key: each.id, ref: _this3.saveNodeType(idx), index: idx },
								props,
								{
									selected: each.selected,
									yValue: (0, _utils2.getValueFromOverride)(
										override,
										idx,
										'yValue',
										each.yValue
