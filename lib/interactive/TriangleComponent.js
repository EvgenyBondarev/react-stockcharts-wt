...
var _EachRectangle = require("react-stockcharts/lib/interactive/wrapper/EachRectangle");

var _EachRectangle2 = _interopRequireDefault(_EachRectangle);
//////
...
var _MouseLocationIndicator = require("react-stockcharts/lib/interactive/components/MouseLocationIndicator");
...
var Rectangle = function (_Component) {
  ...
  //
  {
    ...
    value: function render() {
      ...
      var tempLine = (0, _utils.isDefined)(current) && (0, _utils.isDefined)(current.end) ? _react2.default.createElement(_RectangleSVG2.default, {
        type: type,
        noHover: true,
      ...
      return _react2.default.createElement(
        ...
        trends.map(function (each, idx) {
          ...
          var hoverTextWithDefault = _extends({}, Rectangle.defaultProps.hoverText, hoverText);

          return _react2.default.createElement(_EachRectangle2.default, {
            key: idx,
